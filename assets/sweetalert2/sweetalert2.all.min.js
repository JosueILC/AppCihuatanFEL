...
! function(t, e) {
        ...
        mt = (t, e) => {
            ...
            n && o && (e.showConfirmButton || e.showDenyButton || e.showCancelButton ? X(n) : G(n), U(n, e, "actions"), function(t, e, n) {
                const o = S(),
                    ...
                    s = O();
                if (!o || !i || !s) return;
                gt(o, "confirm", n), gt(i, "deny", n), gt(s, "cancel", n),
                    function(t, e, n, o) {
    ...
    const In = (t, e, n) => new Promise(((o, s) => {
            ...
            Kt.swalPromiseResolve.set(t, o), Kt.swalPromiseReject.set(t, s), e.confirmButton.onclick = () => {
                ...
                qt(e), n.toast || (e.keydownHandler = e => _t(t, e, o), e.keydownTarget = n.keydownListenerCapture ? window : k(), e.keydownListenerCapture = n.keydownListenerCapture, e.keydownTarget.addEventListener("keydown", e.keydownHandler, {
